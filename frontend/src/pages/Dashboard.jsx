...
const Dashboard = () => {
      ...
      <div className="space-y-6">
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-500">
                      Submit new SPMP for evaluation
                    </p>
                  </div>
                </button>
                <button
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <p className="text-gray-600 mb-4">
            The system evaluates SPMP documents against the IEEE 1058 standard,
  ...
  const renderContent = () => {
    ...
    switch (activeTab) {
      ...
      // Student tabs
      case "upload":
        return <DocumentUpload onUploadSuccess={triggerRefresh} />;
      ...
      case "progress":
        return (
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <p className="text-gray-600 mb-4">
              Select a student from the Student List tab to view their detailed
              progress.
            </p>
            <button
      ...
      case "grading":
        return <GradingCriteria refreshTrigger={refreshTrigger} />;
